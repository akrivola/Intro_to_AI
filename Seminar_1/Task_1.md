...
Однако, можно усомниться в ее ответах 
125 литров это очень мало
расход 35 л / 100 км, то есть такого бака хватит на 375 км)))
100-150 галлонов это 378-567 л 
но поймать ее на лжи невозможно, она невозмутимо отвечает - "Да, это очень мало."

А если задать вопрос еще раз?
![img_7.png](img_7.png)
Уже лучше, но все равно неверно.

В целом сильно полагаться на ответы бота нельзя, если речь идет о криточески важном принятии решения. Лучше перепроверить его ответы.

---
Также при составлении программ на python мне предлагались достаточно косячные программы, которые сразу выдавыли ошибки. Но на эти ошибки можно указать боту (GPT в тг), он извиняется и выдает откорректированный результат, и , после некоторых итераций можно получить более-менее годный кусок кода. Но это неспециализированные боты, которые могут отвечать на широкий круг вопросов. Думаю существуют более специализированные боты, которые больше разбираются в узких направлениях, там более что они все более и более совершенствуются.
